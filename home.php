...
//---------------------update rating of profile----------------------
  $select_rating = mysql_query("SELECT * from profile where user_name='$username'", $connection);
  ...
  mysql_query("UPDATE profile set rating= '$rating' where user_name = '$username'", $connection);
//----------------------------------------------------------------------
mysql_close($connection);
?>
    ...
    <body style="background-color:#E6E6FA;">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 shade" style="background-color: #F7F7F7; padding : 30px 30px 30px 30px; border-radius:20px; "  >
...
//----------------sorting the answers according to votes and storing it in an array---------------------
...
//---------------------sorting completed------------------------------------------------------------
                ...
                $a=array_shift($aid_array);//used to pop first element in array
                ...
                if($category==$expertise)
                {
...

                    {
                        ...
                        else
                        {
                            ...
                            else echo '<div style="margin-left: 55px; margin-right : 100px;"><span class= "glyphicon glyphicon-info-sign navbar-left" style="color:red;"></span><span style="padding-left:10px;"></span>Oops! No Answers recieved yet. </div>';
